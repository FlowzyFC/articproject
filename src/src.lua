...
function Library:create(options)
	...
	creditsTab:credit{Name = "Flowzy", Description = "UI Library Developer & Script Dev", Discord = "Flowzy#3142"}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer & Script Dev", Discord = "Requiem#2018"}
